...
'Friend Class PCSCRoutines

'    Inherits ModWinsCard

'    Public Shared retCode, hContext, hCard, Protocol As Long
'    Public Shared SendBuff(262), RecvBuff(262) As Byte

'    Public Shared SendLen, RecvLen, nBytesRet, reqType, Aprotocol As Integer
'    Public Shared connActive, autoDet, validATS As Boolean

'    Public Shared dwProtocol As Integer
'    Public Shared cbPciLength As Integer
'    Public Shared dwState, dwActProtocol As Long

'    Public Shared SendRequest As SCARD_IO_REQUEST
'    Public Shared RecvRequest As SCARD_IO_REQUEST

'    Public Shared Response As String = ""
'    Public Shared LastSendByte As String = ""

'    Public Shared ATR(64) As Byte
'    Public Shared ATRLen As Long
...
'                PrintText = ClassWinsCard.ClassWinsCard.GetScardErrMsg(retVal)
...
'        retCode = ClassWinsCard.ClassWinsCard.SCardTransmit(hCard, SendRequest, SendBuff(0), SendLen, SendRequest, RecvBuff(0), RecvLen)
